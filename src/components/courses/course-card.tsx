...
export default function CourseCard({ course, isCompleted, loading, delay = 0 }: CourseCardProps) {
    const CardContent = () => (
        <div className={`bg-white rounded-2xl overflow-hidden border transition-all duration-300 ${isCompleted
            ...
            <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                    <div className={`p-3 rounded-xl ${isCompleted ? 'bg-green-50' : 'bg-blue-50'
                        }`}>
                        <BookOpen className={`h-6 w-6 ${isCompleted ? 'text-green-500' : 'text-blue-500'
                            }`} />
                    </div>
                ...
                {/* Content */}
                <h3 className={`text-xl font-semibold mb-2 transition-colors ${isCompleted
                    ? 'text-green-700'
