    ...
    <div className="mx-auto w-full max-w-3xl text-center">
      ...
      <div className="relative h-32">
        <div className="pointer-events-none absolute left-1/2 top-0 h-[480px] w-[480px] -translate-x-1/2 before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-gradient-to-b before:from-fuchsia-500/25 before:via-fuchsia-500/5 before:via-25% before:to-fuchsia-500/0 before:to-75%">
          <div className="h-32 [mask-image:_linear-gradient(0deg,transparent,theme(colors.white)_20%,theme(colors.black))]">
            {testimonials.map((testimonial, index) => (
              <Transition
                ...
                enter="transition ease-[cubic-bezier(0.69,-0.3,0.32,1)] duration-700 order-first"
        ...
        <div className="relative flex flex-col" ref={testimonialsRef}>
          {testimonials.map((testimonial, index) => (
            <Transition
              ...
              beforeEnter={() => heightFix()}
            >
              <div className="text-2xl font-bold text-blue-900 before:content-['\201C'] after:content-['\201D']">
                {testimonial.quote}
              </div>
            </Transition>
          ))}
