...
const testimonials = [
    {
        ...
        quote: "KAIA Chain's high performance and developer-friendly environment make it the perfect platform for building next-generation dApps. The learning platform helps developers master blockchain development efficiently.",
        name: "Tran Quan",
    ...
    },
    {
        ...
        quote: "The interactive learning experience and hands-on challenges make complex blockchain concepts easy to understand. KAIA's learning platform is revolutionizing blockchain education.",
        name: "Clément Hoang",
