...
export function Footer() {
    ...
    const socialLinks = [
        { label: 'GitHub', href: 'https://github.com/kaiacamp', icon: Github },
        { label: 'Twitter', href: 'https://twitter.com/kaiacamp', icon: Twitter },
        { label: 'LinkedIn', href: 'https://linkedin.com/company/kaiacamp', icon: Linkedin },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <a
                                href="mailto:hello@kaiacamp.dev"
                                className="flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-colors"
                            >
                ...
                <div className="mt-12 pt-8 border-t border-gray-100">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-500 text-sm">
                            © {currentYear} KAIACamp. All rights reserved.
                        </p>
